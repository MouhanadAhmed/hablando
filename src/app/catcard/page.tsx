...
export default function CatCard() {
  ...
  const svgContainerRefXL = useRef<HTMLDivElement>(null);
  const svgContainerRefSm = useRef<HTMLDivElement>(null);
  const scrollDownRef = useRef<HTMLDivElement>(null);
  const scrollDownRefXL = useRef<HTMLDivElement>(null);
  ...
  // Determine which SVG container to use based on screen width
  useEffect(() => {
    const updateScreen = () => {
  ...
  return (
    <div className={` relative z-0`}>
        ...
        <div className="relative">
          ...
          <div ref={svgContainerRefSm} className={`absolute w-[30vw] ${styles.svgTopSm} !left-[0vw] md:!left-[3vw] md:!-top-[40vw] z-[-1] pointer-events-none`}>
            <div className='absolute top-0 w-[90vw] top-[5vw] left-[2.5vw] min-w-[90vw]'>
              <svg className='absolute md:hidden top-0  h-auto max-[400px]:w-full min-w-[198vw]' width="768" height="10423" viewBox="0 0 768 10423" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '85vw', height: 'auto' }}>
                <path d="M113 8221V8221C113 8234.25 123.745 8245 137 8245H315C337.091 8245 355 8262.91 355 8285V8582.5C355 8604.59 337.091 8622.5 315 8622.5H144C121.909 8622.5 104 8640.41 104 8662.5V8723.5C104 8745.59 121.909 8763.5 144 8763.5H220C242.091 8763.5 260 8745.59 260 8723.5V8684.5C260 8662.41 242.091 8644.5 220 8644.5H91H46C23.9086 8644.5 6 8662.41 6 8684.5V9176C6 9198.09 23.9086 9216 46 9216H220C242.091 9216 260 9233.91 260 9256V9294C260 9316.09 242.091 9334 220 9334H154C131.909 9334 114 9316.09 114 9294V9222.5C114 9200.41 131.909 9182.5 154 9182.5H315C337.091 9182.5 355 9200.41 355 9222.5V9719.5C355 9741.59 337.091 9759.5 315 9759.5H154C131.909 9759.5 114 9777.41 114 9799.5V9903.5C114 9925.59 131.909 9943.5 154 9943.5H220C242.091 9943.5 260 9925.59 260 9903.5V9841.5C260 9819.41 242.091 9801.5 220 9801.5H46C23.9086 9801.5 6 9819.41 6 9841.5V10377.5C6 10399.6 23.9086 10417.5 46 10417.5H184.5" stroke="white" strokeWidth="10" strokeLinecap="round" />
                <path d="M10.5 5.5V100.5C10.5 122.591 28.4086 140.5 50.5 140.5H310C332.091 140.5 350 158.409 350 180.5V392.5C350 414.591 332.091 432.5 310 432.5H45.5C23.4086 432.5 5.5 450.409 5.5 472.5V739C5.5 761.091 23.4086 779 45.5 779H315C337.091 779 355 796.909 355 819V985C355 1007.09 337.091 1025 315 1025H48.5C26.4086 1025 8.5 1042.91 8.5 1065V1376.28C8.5 1397.46 25.0111 1414.97 46.1554 1416.21L238.655 1427.51C261.629 1428.86 281 1410.6 281 1387.58V1366C281 1346.95 296.446 1331.5 315.5 1331.5V1331.5C334.554 1331.5 350 1346.95 350 1366V1698.5C350 1720.59 332.091 1738.5 310 1738.5H48.5C26.4086 1738.5 8.5 1756.41 8.5 1778.5V1980.5C8.5 2002.59 26.4086 2020.5 48.5 2020.5H310C332.091 2020.5 350 2038.41 350 2060.5V2458.5C350 2480.59 332.091 2498.5 310 2498.5H48.5C26.4086 2498.5 8.5 2516.41 8.5 2538.5V2990.5C8.5 3012.59 26.4086 3030.5 48.5 3030.5H310C332.091 3030.5 350 3048.41 350 3070.5V3485C350 3507.09 332.091 3525 310 3525H48.5C26.4086 3525 8.5 3542.91 8.5 3565V3996.5C8.5 4018.59 26.4086 4036.5 48.5 4036.5H310C332.091 4036.5 350 4054.41 350 4076.5V4497C350 4519.09 332.091 4537 310 4537H48.5C26.4086 4537 8.5 4554.91 8.5 4577V4992.5C8.5 5014.59 26.4086 5032.5 48.5 5032.5H310C332.091 5032.5 350 5050.41 350 5072.5V5579.5C350 5601.59 332.091 5619.5 310 5619.5H48.5C26.4086 5619.5 8.5 5637.41 8.5 5659.5V6153C8.5 6175.09 26.4086 6193 48.5 6193H310C332.091 6193 350 6210.91 350 6233V7138.5C350 7160.59 332.091 7178.5 310 7178.5H48.5C26.4086 7178.5 8.5 7196.41 8.5 7218.5V8174.45C8.5 8196.17 25.8281 8213.92 47.5387 8214.44L112.5 8216H221.5C243.591 8216 261.5 8198.09 261.5 8176V8120C261.5 8097.91 243.591 8080 221.5 8080H153.5C131.409 8080 113.5 8097.91 113.5 8120V8214" strokeLinecap="round" strokeWidth="10" stroke="#ffffff" />
              </svg>
            </div>
      ...
      <PushUp />
      <div className={`push-container max-md:pt-[23vw]`}>
        <Steps />
      </div>
