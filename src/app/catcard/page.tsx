...
export default function CatCard() {
  ...
  useEffect(() => {
    ...
    const inactiveRef = isLargeScreen ? svgContainerRefXL : svgContainerRef;   
     const activeScrollRef = isLargeScreen ? scrollDownRef : scrollDownRefXL;
    const inactiveScrollRef = isLargeScreen ? scrollDownRefXL : scrollDownRef;
...
<div ref={scrollDownRef} className={`absolute left-[15%]  ${styles.svgTopScroll} top-280 xl:hidden translate-x-[-50%] z-10 text-center`}>
  <p className="text-white text-2xl font-montserrat ">SCROLL <br/> DOWN</p>
        ...
        {/* <div ref={svgContainerRef} className="absolute w-[30vw] left-[15%] z-10"> */}
        <div ref={svgContainerRef} className={`absolute w-[30vw] ${styles.svgTop} left-[15%] z-[-1] pointer-events-none`}>
