...
export default function CatCard() {
  ...
  useEffect(() => {
    ...
    const activeRef = svgContainerRef;
    const inactiveRef = svgContainerRefXL;
    const activeScrollRef = scrollDownRef;
    const inactiveScrollRef = scrollDownRefXL;
  ...
  return (
    <div className={`${styles.backgroundGradient} relative z-0`}>
      ...
      <HeroSection />
        <div ref={scrollDownRef} className={`absolute left-[8%] lg:left-[10%] lg:!top-[45vw] lg:left-[10vw] ${styles.svgTopScroll} top-280 xl:hidden translate-x-[-50%] z-10 text-center`}>
        ...
        {/* <div ref={svgContainerRef} className="absolute w-[30vw] left-[15%] z-10"> */}
        <div ref={svgContainerRef} className={`absolute w-[30vw] ${styles.svgTop} !left-[0vw] lg:!left-[3vw] lg:!top-[50vw] z-[-1] pointer-events-none`}>

          <svg className='max-lg:!w-[90vw]' width="1500" height="16718" viewBox="0 0 1500 16718" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '85vw', height: 'auto' }}>
            ...
            <defs>
              <clipPath id="clip0_79_6">
                <rect width="1500" height="16717" fill="white" transform="translate(0 0.5)" />
              </clipPath>
            </defs>
          </svg>
        ...
        <div className=''>
          ...
          <div className='max-lg:!pt-[13vw] lg:!pt-[65vw]'>
            <WhatYouGet />
          </div>
