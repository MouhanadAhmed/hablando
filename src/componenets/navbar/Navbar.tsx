  ...
  return (
    <div className="flex justify-between md:px-[2vw] px-5 items-center max-md:py-3" >
      ...
      <div className="flex justify-between max-md:gap-[18px] gap-[2vw] items-center" >
        ...
        <button className="max-md:py-1 max-md:px-3 max-md:bg-[#B1022980] max-md:rounded-[8px] max-md:text-xl max-md:uppercase text-[2vw] md:text-[1.5vw] cursor-pointer" onClick={() => window.alert('login')}>
