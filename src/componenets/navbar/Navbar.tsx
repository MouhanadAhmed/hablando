...
<div className="flex justify-between gap-8 items-center" >
     ...
     <button className="font-montserrat text-2xl font-semibold cursor-pointer" onClick={openDialog}>   <Image
              className="me-2"
              src={seachIcon}
              alt="CatCard logo"
              width={24}
              height={24}
            /></button>
     <button className="font-montserrat text-2xl font-semibold cursor-pointer"  onClick={openDialog}>Login</button>
